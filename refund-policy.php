...
<style>
  ...
  *{box-sizing:border-box;}
  ...
  .content-section h2{font-size:18px;color:var(--ink);border-left:3px solid var(--amber);padding-left:12px;margin-top:24px;}
...
<header>
  <div class="nav">
    <a href="index.php" class="brand">
      <img src="assets/images/logo.jpg" alt="Aff Digital" style="height:32px; width:auto; border-radius:6px; object-fit:cover;">
      Aff Digital
    </a>
